...
const NIFTY_50_CONSTITUENTS = [
  { name: "Reliance Industries", ticker: "RELIANCE.NS", sector: "Energy", weight: "10.4%", basePrice: 1308.6, change: -0.46 },
  { name: "HDFC Bank", ticker: "HDFCBANK.NS", sector: "Banking", weight: "9.8%", basePrice: 750.5, change: 0.3 },
  { name: "ICICI Bank", ticker: "ICICIBANK.NS", sector: "Banking", weight: "7.9%", basePrice: 1233.9, change: 0.6 },
  { name: "Infosys", ticker: "INFY.NS", sector: "IT", weight: "5.8%", basePrice: 1222.4, change: -3.81 },
  { name: "Larsen & Toubro", ticker: "LT.NS", sector: "Engineering", weight: "4.4%", basePrice: 3940.7, change: -1.5 },
  { name: "TCS", ticker: "TCS.NS", sector: "IT", weight: "4.2%", basePrice: 2239.4, change: -8.48 },
  { name: "ITC", ticker: "ITC.NS", sector: "FMCG", weight: "3.8%", basePrice: 278.0, change: -1.85 },
  { name: "Hindustan Unilever", ticker: "HINDUNILVR.NS", sector: "FMCG", weight: "2.7%", basePrice: 2090.0, change: -0.18 },
  { name: "Axis Bank", ticker: "AXISBANK.NS", sector: "Banking", weight: "2.5%", basePrice: 1253.3, change: 0.18 },
  { name: "State Bank of India", ticker: "SBIN.NS", sector: "Banking", weight: "2.4%", basePrice: 952.0, change: -0.49 },
  { name: "Bharti Airtel", ticker: "BHARTIARTL.NS", sector: "Telecom", weight: "2.3%", basePrice: 1821.1, change: 0.38 },
  { name: "Kotak Mahindra Bank", ticker: "KOTAKBANK.NS", sector: "Banking", weight: "2.2%", basePrice: 380.5, change: 0.38 },
  { name: "Tata Motors", ticker: "TATAMOTORS.NS", sector: "Automobile", weight: "1.9%", basePrice: 920.4, change: 1.65 },
  { name: "Sun Pharma", ticker: "SUNPHARMA.NS", sector: "Pharma", weight: "1.5%", basePrice: 1759.4, change: -1.7 },
  { name: "NTPC", ticker: "NTPC.NS", sector: "Energy", weight: "1.4%", basePrice: 366.3, change: -0.3 },
  { name: "Maruti Suzuki", ticker: "MARUTI.NS", sector: "Automobile", weight: "1.3%", basePrice: 13155.0, change: 1.02 },
  { name: "HCL Technologies", ticker: "HCLTECH.NS", sector: "IT", weight: "1.2%", basePrice: 1183.4, change: -4.83 },
  { name: "Power Grid", ticker: "POWERGRID.NS", sector: "Energy", weight: "1.1%", basePrice: 284.6, change: 0.87 },
  { name: "UltraTech Cement", ticker: "ULTRACEMCO.NS", sector: "Materials", weight: "1.0%", basePrice: 11071.0, change: -0.84 },
  { name: "Titan Company", ticker: "TITAN.NS", sector: "Consumer Durables", weight: "0.9%", basePrice: 4029.5, change: -1.19 },
  { name: "Adani Enterprises", ticker: "ADANIENT.NS", sector: "Diversified", weight: "0.9%", basePrice: 2933.7, change: -1.16 },
  { name: "Adani Ports", ticker: "ADANIPORTS.NS", sector: "Infrastructure", weight: "0.8%", basePrice: 1801.3, change: -0.73 },
  { name: "Apollo Hospitals", ticker: "APOLLOHOSP.NS", sector: "Healthcare", weight: "0.8%", basePrice: 8304.0, change: 2.65 },
  { name: "Asian Paints", ticker: "ASIANPAINT.NS", sector: "Consumer Goods", weight: "0.8%", basePrice: 2666.6, change: 0.22 },
  { name: "Bajaj Auto", ticker: "BAJAJ-AUTO.NS", sector: "Automobile", weight: "0.8%", basePrice: 10246.0, change: -0.34 },
  { name: "Bajaj Finance", ticker: "BAJFINANCE.NS", sector: "Financial Services", weight: "0.8%", basePrice: 872.45, change: -1.08 },
  { name: "Bajaj Finserv", ticker: "BAJAJFINSV.NS", sector: "Financial Services", weight: "0.7%", basePrice: 1728.9, change: -0.72 },
  { name: "Bharat Electronics", ticker: "BEL.NS", sector: "Engineering", weight: "0.7%", basePrice: 405.1, change: -0.67 },
  { name: "Cipla", ticker: "CIPLA.NS", sector: "Pharma", weight: "0.7%", basePrice: 1376.6, change: -0.2 },
  { name: "Coal India", ticker: "COALINDIA.NS", sector: "Energy", weight: "0.7%", basePrice: 471.05, change: -0.23 },
  { name: "Dr. Reddy's", ticker: "DRREDDY.NS", sector: "Pharma", weight: "0.6%", basePrice: 1263.7, change: -0.81 },
  { name: "Eicher Motors", ticker: "EICHERMOT.NS", sector: "Automobile", weight: "0.6%", basePrice: 7115.0, change: -0.37 },
  { name: "Grasim Industries", ticker: "GRASIM.NS", sector: "Materials", weight: "0.6%", basePrice: 3088.2, change: -0.3 },
  { name: "HDFC Life", ticker: "HDFCLIFE.NS", sector: "Financial Services", weight: "0.6%", basePrice: 574.95, change: -0.85 },
  { name: "Hindalco Industries", ticker: "HINDALCO.NS", sector: "Metals", weight: "0.5%", basePrice: 1138.3, change: -0.7 },
  { name: "InterGlobe Aviation", ticker: "INDIGO.NS", sector: "Aviation", weight: "0.5%", basePrice: 4445.7, change: -0.46 },
  { name: "Jio Financial Services", ticker: "JIOFIN.NS", sector: "Financial Services", weight: "0.5%", basePrice: 233.85, change: -1.59 },
  { name: "JSW Steel", ticker: "JSWSTEEL.NS", sector: "Metals", weight: "0.5%", basePrice: 1308.3, change: -0.19 },
  { name: "Mahindra & Mahindra", ticker: "M&M.NS", sector: "Automobile", weight: "0.5%", basePrice: 3018.6, change: 0.68 },
  { name: "Max Healthcare", ticker: "MAXHEALTH.NS", sector: "Healthcare", weight: "0.5%", basePrice: 963.35, change: 1.54 },
  { name: "Nestle India", ticker: "NESTLEIND.NS", sector: "FMCG", weight: "0.5%", basePrice: 1396.0, change: -0.19 },
  { name: "ONGC", ticker: "ONGC.NS", sector: "Energy", weight: "0.4%", basePrice: 266.55, change: 0.57 },
  { name: "SBI Life", ticker: "SBILIFE.NS", sector: "Financial Services", weight: "0.4%", basePrice: 1773.4, change: -1.57 },
  { name: "Shriram Finance", ticker: "SHRIRAMFIN.NS", sector: "Financial Services", weight: "0.4%", basePrice: 898.75, change: -1.42 },
  { name: "Tata Consumer", ticker: "TATACONSUM.NS", sector: "FMCG", weight: "0.4%", basePrice: 1145.9, change: -0.76 },
  { name: "Tata Steel", ticker: "TATASTEEL.NS", sector: "Metals", weight: "0.4%", basePrice: 209.95, change: -0.31 },
  { name: "Tech Mahindra", ticker: "TECHM.NS", sector: "IT", weight: "0.4%", basePrice: 1483.7, change: -5.58 },
  { name: "Trent", ticker: "TRENT.NS", sector: "Retail", weight: "0.4%", basePrice: 4260.9, change: 1.2 },
  { name: "Wipro", ticker: "WIPRO.NS", sector: "IT", weight: "0.4%", basePrice: 204.11, change: -2.73 }
]
